            ...
            public override string ToString()
            {
                return
                    string.Format(
                        ...
                        PointerToSymbolTable.ToString("X"), NumberOfSymbols.ToString("X"),
                        SizeOfOptionalHeader.ToString("X"), Characteristics.ToString("X"));
            }
        }
            ...
            public override string ToString()
            {
                ...
                return
                    string.Format(
                        ...
                        SizeOfCode.ToString("X"), SizeOfInitializedData.ToString("X"),
                        SizeOfUninitializedData.ToString("X"), AddressOfEntryPoint.ToString("X"),
                        BaseOfCode.ToString("X"), BaseOfData.ToString("X"), ImageBase.ToString("X"),
                        ...
                        MajorSubsystemVersion.ToString("X"), MinorSubsystemVersion.ToString("X"),
                        Win32VersionValue.ToString("X"), SizeOfImage.ToString("X"), SizeOfHeaders.ToString("X"),
                        CheckSum.ToString("X"), Subsystem.ToString("X"), DllCharacteristics.ToString("X"),
                        SizeOfStackReserve.ToString("X"), SizeOfStackCommit.ToString("X"),
                        SizeOfHeapReserve.ToString("X"), SizeOfHeapCommit.ToString("X"), LoaderFlags.ToString("X"),
                        NumberOfRvaAndSizes.ToString("X"), dataDir);
            }
        }
